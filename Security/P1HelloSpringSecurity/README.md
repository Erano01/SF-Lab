...
HTTP Basic authentication çoğu uygulama mimarisine uymaz. Bazen bunu uygulamamıza uyacak şekilde değiştirmek isteyebiliriz. Benzer şekilde, bir uygulamanın tüm endpointlerinin güvenli olması gerekmez ve güvenli olması gerekenler için farklı authentication methodları ve authorization kuralları seçmemiz gerekebilir.
Authentication ve authorization'u özelleştirmek için, SecurityFilterChain tipinde bir bean tanımlamamız gerekecek.
